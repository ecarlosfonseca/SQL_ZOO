/* Exercise 1. The example uses a WHERE clause to show the population of 'France'. Note that strings 
...
SELECT population FROM world
 ...
 /* Exercise 2. TChecking a list: The word IN allows us to check if an item is in a list. The example 
...
SELECT name, population FROM world
 ...
 /* Exercise 3. Which countries are not too small and not too big? BETWEEN allows range checking 
